...
T = {
    ...
    "ad_fee_note": {
        "ru": "💳 Размещение объявления о продаже — {fee}₪. После модерации мы пришлём реквизиты; объявление публикуется после оплаты.",
        "en": "💳 Posting a “for sale” ad costs {fee}₪. After moderation we will send payment details; the ad is published after payment.",
        "he": "💳 פרסום מודעת מכירה — {fee}₪. לאחר האישור נשלח פרטי תשלום; המודעה תפורסם לאחר התשלום.",
    },
